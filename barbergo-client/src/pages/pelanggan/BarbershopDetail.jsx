...
import api from '../../api';
import { Star, MapPin, Clock, Calendar, Scissors, ChevronLeft } from 'lucide-react';
        ...
        <section>
            ...
            <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                <div className="flex justify-between items-center max-w-xs">
                    ...
                    <span className="font-medium text-white">{barbershop.jam_buka} - {barbershop.jam_tutup}</span>
                </div>
            </div>
        </section>
